    ...
    return (
        <div className="page-container">
            ...
            <div style={{ padding: '4rem 2rem' }}>
                ...
                <p>Accessible by customers</p>

                <div className="customer-buttons">
                    <button onClick={() => handleNavigate("/shop")}>Shop Products</button>
                    <button onClick={() => handleNavigate("/cart")}>Cart/Payments</button>
                    <button onClick={() => handleNavigate("/user/orders")}>My Orders</button>
                    <button onClick={() => handleNavigate("/user/tickets")}>Support & Warranty Tickets</button>
                </div>
            </div>
