...
const BasinsPage = ({ onBack, onAddToCart, cartCount = 0, isAuthenticated = true }) => {
  const navigate = useNavigate();
  const [basinProducts, setBasinProducts] = useState([]);
  ...
  const fetchProducts = async () => {
    try {
      ...
      setBasinProducts(filteredProducts);
    } catch (error) {
      ...
      <section className="shop-hero">
        ...
        <div className="shop-hero-content">
          <h1 className="shop-hero-title">
            Basins
            <span className="shop-hero-gradient">Elegant Design</span>
          </h1>
          <p className="shop-hero-description">
            Elegant wash basins and sinks for every style. Choose from our premium collection of ceramic, granite, and modern basin designs.
          </p>
        </div>
